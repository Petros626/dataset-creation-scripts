...
# camera after 5s and saves them in the specified directory. The default directory is 'images' and the
# default resolution is 1920x1080.

# Example usage to save images in a directory named calibration_images at 1920x1080 resolution:
# python3 run_camera_config.py --imgdir=calibration_images --res=1920x1080 --time=5
...
parser.add_argument("--res", help = "Required resolution in WxH. To avoid erros find out about the supported resolutions of your camera model.",
                       default = "1920x1080")
parser.add_argument("--time", help = "Time until an image is taken.",
                        default = "5")
...
print("\n##################################")
print("### Time triggered image taker ###")
print("##################################")
    ...
    while 1:
        if is_pressed("p"):
            if key_flag == 0:
                ...
                print("\rTimer triggered, please wait {}s...".format(time))
                sleep(5)
